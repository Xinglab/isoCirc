...
The input file in this script is 'all_samples_isocirc4overlap_nanopore_raw_0417.txt' generated in the above step. Please alter this input file and labels/output files to generate a new Venn graph.

3) miRNA_binding_site_isoforms_isocirc.pl 
This script outputs the miRNA seeds in all detected circRNA isoforms.
...
Next, the file lists each circRNA ID, sequence, and miRNA seed found in the sequence. Only miRNA seeds found more than 3 times in a circRNA are listed.
...
4) isoform_analysis.tar.gz is a zipped TAR file containing various scripts for analyzing the circRNA isoforms detected by isoCirc. 

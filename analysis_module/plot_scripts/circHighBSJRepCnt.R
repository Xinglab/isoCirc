...
ggplot(data, aes(scal_f(Count), colour=RepAnno)) +
	...
	xlab(xlab) +
	ylab(ylab) +
	# scale_x_continuous(breaks=c(0, 3.321928094887362, 5.643856189774724, 6.643856189774724, 9.965784284662087, 11.965784284662087), labels=c("1", "10", "50", "100", "1,000", "4,000"), limits=c(0,11.965784284662087)) +
	# scale_x_continuous(breaks=c(1, 3.321928094887362, 5.643856189774724, 6.643856189774724, 9.965784284662087, 11.965784284662087), labels=c("2", "10", "50", "100", "1,000", "4,000"), limits=c(1,11.965784284662087)) +
